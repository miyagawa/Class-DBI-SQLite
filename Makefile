# This Makefile is for the Class::DBI::SQLite extension to perl.
#
...
#	NAME => q[Class::DBI::SQLite]
#	PREREQ_PM => { DBD::SQLite=>q[0.07], Class::DBI=>q[0.85], Test::More=>q[0.32] }
#	VERSION_FROM => q[lib/Class/DBI/SQLite.pm]
...
DISTNAME = Class-DBI-SQLite
NAME_SYM = Class_DBI_SQLite
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
FULLEXT = Class/DBI/SQLite
BASEEXT = SQLite
PARENT_NAME = Class::DBI
DLBASE = $(BASEEXT)
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/Class/DBI/SQLite.pm
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Class/DBI
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Class/DBI
...
TO_INST_PM = lib/Class/DBI/SQLite.pm

PM_TO_BLIB = lib/Class/DBI/SQLite.pm \
	$(INST_LIB)/Class/DBI/SQLite.pm
...
manifypods : pure_all lib/Class/DBI/SQLite.pm
	@$(POD2MAN) \
	lib/Class/DBI/SQLite.pm \
	$(INST_MAN3DIR)/Class::DBI::SQLite.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIB)/Class/DBI/SQLite.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Class-DBI-SQLite\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Class-DBI-SQLite</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Class-DBI\" VERSION=\"0,85,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"DBD-SQLite\" VERSION=\"0,07,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,32,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-freebsd\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Class-DBI-SQLite.ppd
